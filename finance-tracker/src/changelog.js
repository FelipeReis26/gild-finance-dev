...
export const changelog = [
  {
    version: '2.1.0',
    summary: 'Calmer, more honest dashboard and a proper tab bar',
    changes: [
      ...
      'Consistent colours throughout: green always means money in, gold money out, and the alert colour is reserved for genuinely over-budget',
      'Navigation moved to a bottom tab bar (Dashboard, Activity, Bills, Scan, and More) instead of a single menu button, so every main screen is one tap away',
