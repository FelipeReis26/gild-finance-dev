...
export const changelog = [
  {
    ...
    changes: [
      ...
      'Fixed Undo after deleting a transaction restoring it twice over',
      ...
      'The Add bill screen now matches the Add transaction screen: the amount is set in large figures, the category is picked from tappable chips instead of a dropdown, and errors clear as you fix them',
      'The app now installs to your home screen as "GILD" rather than "Finance Tracker"',
      'Backups are tagged with the correct app version again, and the last two English-only button labels are translated',
      'Version history is now a list you can tap open, instead of every release printed out in full',
