...
const strings = {
  ...
  billNamePlaceholder: { en: 'Rent', fr: 'Loyer', 'pt-BR': 'Aluguel', it: 'Affitto', es: 'Alquiler' },
  ...
  repaymentLabel: { en: 'Is someone paying you back?', fr: "Est-ce qu'on vous rembourse ?", 'pt-BR': 'Alguém está te pagando de volta?', it: 'Qualcuno ti sta restituendo dei soldi?', es: '¿Alguien te está devolviendo dinero?' },
  notARepayment: { en: 'No — regular income', fr: 'Non — revenu normal', 'pt-BR': 'Não — renda normal', it: 'No — entrata normale', es: 'No — ingreso normal' },
  stillOwed: { en: 'still owed', fr: 'encore dû', 'pt-BR': 'ainda devido', it: 'ancora dovuto', es: 'aún pendiente' },
  settledUp: { en: '— settled up', fr: '— soldé', 'pt-BR': '— quitado', it: '— saldato', es: '— liquidado' },
  amountRepaid: { en: 'Amount repaid', fr: 'Montant remboursé', 'pt-BR': 'Valor pago de volta', it: 'Importo restituito', es: 'Importe devuelto' },
  logPayment: { en: 'Log payment', fr: 'Enregistrer un paiement', 'pt-BR': 'Registrar pagamento', it: 'Registra pagamento', es: 'Registrar pago' },
  addToSavings: { en: 'Add to savings', fr: 'Ajouter à l\'épargne', 'pt-BR': 'Adicionar à poupança', it: 'Aggiungi ai risparmi', es: 'Añadir a ahorros' },
  amountPaid: { en: 'Amount paid', fr: 'Montant payé', 'pt-BR': 'Valor pago', it: 'Importo pagato', es: 'Importe pagado' },
  amountAdded: { en: 'Amount added', fr: 'Montant ajouté', 'pt-BR': 'Valor adicionado', it: 'Importo aggiunto', es: 'Importe añadido' },
  alsoLogAsExpense: { en: 'Also add this as an expense', fr: 'Ajouter aussi comme dépense', 'pt-BR': 'Também adicionar como despesa', it: 'Aggiungi anche come spesa', es: 'Añadir también como gasto' },
  savedLabel: { en: 'saved', fr: 'épargné', 'pt-BR': 'guardado', it: 'risparmiato', es: 'ahorrado' },
  fromAccountPayment: { en: 'Payment', fr: 'Paiement', 'pt-BR': 'Pagamento', it: 'Pagamento', es: 'Pago' },
  alsoLogAsIncome: { en: 'Also add this as income', fr: 'Ajouter aussi comme revenu', 'pt-BR': 'Também adicionar como renda', it: 'Aggiungi anche come entrata', es: 'Añadir también como ingreso' },
  backupNotGild: { en: 'This file does not look like a GILD backup.', fr: "Ce fichier ne ressemble pas à une sauvegarde GILD.", 'pt-BR': 'Este arquivo não parece ser um backup do GILD.', it: 'Questo file non sembra un backup di GILD.', es: 'Este archivo no parece una copia de seguridad de GILD.' },
  backupNoData: { en: 'This file has no recognizable GILD data in it.', fr: "Ce fichier ne contient aucune donnée GILD reconnaissable.", 'pt-BR': 'Este arquivo não contém dados do GILD reconhecíveis.', it: 'Questo file non contiene dati GILD riconoscibili.', es: 'Este archivo no contiene datos de GILD reconocibles.' },
  backupOlderVersion: { en: 'No version tag found — this looks like an older backup and will be converted automatically.', fr: "Aucune version trouvée — cette sauvegarde semble plus ancienne et sera convertie automatiquement.", 'pt-BR': 'Nenhuma versão encontrada — este backup parece antigo e será convertido automaticamente.', it: 'Nessuna versione trovata — sembra un backup più vecchio e verrà convertito automaticamente.', es: 'No se encontró versión — parece una copia antigua y se convertirá automáticamente.' },
  backupNewerVersion: { en: 'This backup was made with a newer version of the app than this one. Some data may not restore correctly.', fr: "Cette sauvegarde a été créée avec une version plus récente de l'application. Certaines données pourraient ne pas être restaurées correctement.", 'pt-BR': 'Este backup foi feito com uma versão mais nova do app. Alguns dados podem não ser restaurados corretamente.', it: 'Questo backup è stato creato con una versione più recente dell\'app. Alcuni dati potrebbero non essere ripristinati correttamente.', es: 'Esta copia se hizo con una versión más nueva de la app. Algunos datos podrían no restaurarse correctamente.' },
  fromRepayment: { en: 'Repayment', fr: 'Remboursement', 'pt-BR': 'Pagamento de volta', it: 'Rimborso', es: 'Devolución' },
  ...
  incomeBreakdown: { en: 'Income breakdown', fr: 'Répartition des revenus', 'pt-BR': 'Composição da receita', it: 'Composizione delle entrate', es: 'Desglose de ingresos' },
  excludeFromTotals: { en: 'Exclude from spending totals', fr: 'Exclure des totaux de dépenses', 'pt-BR': 'Excluir dos totais de gastos', it: 'Escludi dai totali di spesa', es: 'Excluir de los totales de gasto' },
  excludeFromTotalsNote: { en: 'Transactions still show in Activity, they just do not count as spending or income.', fr: "Les transactions restent visibles dans l'activité, elles ne comptent simplement pas comme dépenses ou revenus.", 'pt-BR': 'As transações continuam aparecendo na atividade, apenas não contam como gasto ou receita.', it: "Le transazioni restano visibili nell'attività, semplicemente non contano come spesa o entrata.", es: 'Las transacciones siguen apareciendo en la actividad, solo no cuentan como gasto ni ingreso.' },
  excludeAlwaysTransfer: { en: 'Always excluded: this is a transfer category', fr: 'Toujours exclu : catégorie de virement', 'pt-BR': 'Sempre excluído: categoria de transferência', it: 'Sempre escluso: categoria di giroconto', es: 'Siempre excluido: categoría de traspaso' },
  editBill: { en: 'Edit bill', fr: 'Modifier la facture', 'pt-BR': 'Editar conta', it: 'Modifica bolletta', es: 'Editar factura' },
  saveChanges: { en: 'Save changes', fr: 'Enregistrer', 'pt-BR': 'Salvar alterações', it: 'Salva modifiche', es: 'Guardar cambios' },
  linkedBalance: { en: 'Link to a balance account', fr: 'Lier à un compte de solde', 'pt-BR': 'Vincular a uma conta de saldo', it: 'Collega a un conto di saldo', es: 'Vincular a una cuenta de saldo' },
  linkedBalanceNone: { en: 'Not linked', fr: 'Non lié', 'pt-BR': 'Não vinculado', it: 'Non collegato', es: 'Sin vincular' },
  linkedBalanceNote: { en: 'Expenses filed here will bring that debt down on their own, so you do not have to update Balances by hand.', fr: 'Les dépenses classées ici feront baisser cette dette automatiquement, sans avoir à mettre à jour les soldes à la main.', 'pt-BR': 'Despesas lançadas aqui reduzem essa dívida automaticamente, sem precisar atualizar os saldos à mão.', it: 'Le spese registrate qui ridurranno quel debito da sole, senza aggiornare i saldi a mano.', es: 'Los gastos registrados aquí reducirán esa deuda por sí solos, sin actualizar los saldos a mano.' },
  noDebtAccounts: { en: 'No debt accounts to link to yet', fr: 'Aucun compte de dette à lier', 'pt-BR': 'Nenhuma conta de dívida para vincular', it: 'Nessun conto di debito da collegare', es: 'Aún no hay cuentas de deuda que vincular' },
  autoBalanceUpdated: { en: 'Also updated {name} to {value}', fr: '{name} mis à jour à {value}', 'pt-BR': '{name} também atualizado para {value}', it: 'Aggiornato anche {name} a {value}', es: '{name} también actualizado a {value}' },
  autoTag: { en: 'auto', fr: 'auto', 'pt-BR': 'auto', it: 'auto', es: 'auto' },
  transferTag: { en: 'transfer', fr: 'virement', 'pt-BR': 'transferência', it: 'giroconto', es: 'traspaso' },
  cashBalance: { en: 'Cash balance', fr: 'Solde disponible', 'pt-BR': 'Saldo em caixa', it: 'Saldo disponibile', es: 'Saldo disponible' },
  cashNote: { en: 'A running balance: a figure you know was true on a date, plus every transaction logged since. It is only as accurate as your logging, so reconcile it against your real balance now and then.', fr: "Un solde courant : un montant que vous savez exact à une date, plus chaque transaction enregistrée depuis. Il n'est aussi juste que vos saisies, donc rapprochez-le de votre solde réel de temps en temps.", 'pt-BR': 'Um saldo corrente: um valor que você sabe que era verdade numa data, mais cada transação registrada desde então. Ele só é tão exato quanto seus registros, então reconcilie com seu saldo real de vez em quando.', it: 'Un saldo progressivo: un importo che sai era corretto a una data, più ogni transazione registrata da allora. È accurato solo quanto le tue registrazioni, quindi riconcilialo con il saldo reale di tanto in tanto.', es: 'Un saldo corriente: un importe que sabes que era correcto en una fecha, más cada transacción registrada desde entonces. Solo es tan exacto como tus registros, así que concílialo con tu saldo real de vez en cuando.' },
  cashShowOnDashboard: { en: 'Show on the dashboard', fr: 'Afficher sur le tableau de bord', 'pt-BR': 'Mostrar no painel', it: 'Mostra nella dashboard', es: 'Mostrar en el panel' },
  cashOpeningValue: { en: 'Balance you know is correct', fr: 'Solde que vous savez exact', 'pt-BR': 'Saldo que você sabe estar correto', it: 'Saldo che sai essere corretto', es: 'Saldo que sabes correcto' },
  cashOpeningDate: { en: 'Correct as of', fr: 'Exact au', 'pt-BR': 'Correto em', it: 'Corretto al', es: 'Correcto a fecha de' },
  cashSince: { en: 'since', fr: 'depuis le', 'pt-BR': 'desde', it: 'dal', es: 'desde el' },
  cashCounted: { en: 'entries counted', fr: 'entrées comptées', 'pt-BR': 'lançamentos contados', it: 'voci conteggiate', es: 'apuntes contados' },
  cashReconcile: { en: 'Reconcile', fr: 'Rapprocher', 'pt-BR': 'Reconciliar', it: 'Riconcilia', es: 'Conciliar' },
  cashReconcileNote: { en: 'Enter what your account actually says. Any difference is something that was never logged — a withdrawal, a transfer, a forgotten expense. Re-anchoring makes the figure true again from today.', fr: "Entrez ce que dit réellement votre compte. Toute différence correspond à quelque chose qui n'a jamais été saisi — un retrait, un virement, une dépense oubliée. Le recalage rend le montant juste à partir d'aujourd'hui.", 'pt-BR': 'Digite o que sua conta realmente diz. Qualquer diferença é algo que nunca foi registrado — um saque, uma transferência, uma despesa esquecida. Reancorar torna o valor verdadeiro a partir de hoje.', it: "Inserisci quello che dice davvero il tuo conto. Ogni differenza è qualcosa che non è mai stato registrato — un prelievo, un bonifico, una spesa dimenticata. Riancorare rende l'importo di nuovo corretto da oggi.", es: 'Introduce lo que dice realmente tu cuenta. Cualquier diferencia es algo que nunca se registró — una retirada, una transferencia, un gasto olvidado. Reanclar hace que el importe vuelva a ser correcto desde hoy.' },
  cashRealValue: { en: 'What your account actually says', fr: 'Ce que dit votre compte', 'pt-BR': 'O que sua conta realmente diz', it: 'Quanto dice il tuo conto', es: 'Lo que dice tu cuenta' },
  cashMatches: { en: 'Matches — nothing missing', fr: 'Correspond — rien ne manque', 'pt-BR': 'Bate — nada faltando', it: 'Corrisponde — non manca nulla', es: 'Coincide — no falta nada' },
  cashUnaccounted: { en: 'unaccounted for', fr: 'non justifié', 'pt-BR': 'não justificado', it: 'non giustificato', es: 'sin justificar' },
  cashReAnchor: { en: 'Use this figure from today', fr: "Utiliser ce montant à partir d'aujourd'hui", 'pt-BR': 'Usar este valor a partir de hoje', it: 'Usa questo importo da oggi', es: 'Usar este importe desde hoy' },
